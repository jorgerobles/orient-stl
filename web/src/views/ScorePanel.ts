...
const METRIC_NAMES = ['Supports', 'Bed Space', 'Layer Width', 'Finish', 'Height Risk', 'Reachability'];
const METRIC_DESCS = [
  ...
  'How accessible support-free areas are — higher means fewer hidden spots',
];
